...
module.exports = function(context) {
    ...
    function hasLeadingSpace(token) {
        ...
        return tokenBefore && ( astUtils.isTokenOnSameLine(tokenBefore, token) || isLastTokenInCurrentLine(token) && isFirstTokenInCurrentLine(token) ) && sourceCode.isSpaceBetweenTokens(tokenBefore, token)
    }
    ...
    function hasTrailingSpace(token) {
        ...
        return tokenAfter && ( astUtils.isTokenOnSameLine(token, tokenAfter) || isLastTokenInCurrentLine(token) && isFirstTokenInCurrentLine(token) ) && sourceCode.isSpaceBetweenTokens(token, tokenAfter)
    }
